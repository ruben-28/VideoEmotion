...
class PathResolver:
    ...
    def __init__(self, project_root: Path):
        ...
        self.output_reports_offline = self.project_root / "output" / "reports" / "offline"
        self.output_realtime = self.project_root / "output" / "realtime"
    
    def find_latest_session(self, video_name: str, mode: str = "offline") -> Optional[Path]:
        """
    ...
    def get_video_paths(self, video_name: str, mode: str = "offline") -> Dict[str, Optional[Path]]:
        """
    ...
    def validate_video_files(self, video_name: str, mode: str = "offline") -> Dict[str, bool]:
        """
        ...
        return {
            ...
            "has_session": paths["session_dir"] is not None and paths["session_dir"].exists(),
        }
    
    def get_all_sessions(self, video_name: str, mode: str = "offline") -> List[Tuple[str, Path]]:
        """
    ...
    def resolve_summary_file(self, video_name: str, mode: str = "offline") -> Optional[Path]:
        """
