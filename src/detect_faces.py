...
#     On reste safe: si clé absente => on ne change rien.
#     """
...
#     # Override globals depuis config
...
#     detect_faces_in_all_frames(str(extracted_frames_root), str(detected_faces_root))
