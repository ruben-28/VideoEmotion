...
#         "--video",
#         default=None,
#         help="Chemin d'une vidéo spécifique (si fourni, on ne traite que celle-là).",
#     )
#     parser.add_argument(
#         "--videos-dir",
#         default=None,
...
#         "--output",
#         default=None,
#         help="Dossier racine de sortie pour extracted_frames.",
#     )
#     parser.add_argument(
#         "--fps",
#         type=int,
#         default=5,
#         help="FPS d'extraction (défaut: 5).",
#     )
...
#     videos_dir = Path(args.videos_dir).resolve() if args.videos_dir else (project_root / "data" / "videos")
#     extracted_root = Path(args.output).resolve() if args.output else (project_root / "data" / "extracted_frames")
...
#     main()
# #commande to extract frames from a specific video
# # python src/extract_frames.py --video data/videos/test_pipeline.mp4 --fps 5

# #commande to extract frames from all videos in a folder
# # python src/extract_frames.py --videos-dir data/videos --output data/extracted_frames --fps 5
