    ...
    return JSONResponse(
        ...
        content={
            "error": {
                ...
                "details": str(exc) # TODO: Hide details in production
            }
        },
    )
...
app.mount("/static/videos", StaticFiles(directory=settings.server.PROJECT_ROOT / settings.project.paths.videos), name="videos")
app.mount("/static/output", StaticFiles(directory=settings.server.PROJECT_ROOT / "output"), name="output")
